...
[_BASE] = LAYOUT(
 KC_ESC, KC_GRAVE,  KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9,    KC_0,    KC_MINS, KC_EQL, XXXXXXX, KC_BSLS, \
...
[_FUNC] = LAYOUT(
 ...
 RGB_MOD, KC_CAPS, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
